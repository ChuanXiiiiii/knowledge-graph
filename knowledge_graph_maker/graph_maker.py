...
class GraphMaker:
    ...
    def system_message(self) -> str:
        return (
            "You are an expert at creating Knowledge Graphs. My text data is related to Harry Potter novels, and the knowledge extracted is based on the relevant structure and characters of Harry Potter novels."
    ...
    def from_documents(
        ...
        for index, doc in enumerate(docs):
            try:
                ...
                print(f"Extracted {len(subgraph)} Edges")
                ...
                print(e)
                print(f"Error in Document: {index+1}")
                print(f"FAULTY DOCUMENT: {doc}")
                return graph


        print(f"Total Edges: {len(graph)}")
        return graph
